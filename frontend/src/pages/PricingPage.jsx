  ...
  return (
    <div className="pt-16 mt-16 bg-white">
      ...
      <section className="relative text-gray-900 py-24 text-center overflow-hidden">
        ...
        >
             <span className="bg-orange-50 text-orange-600 px-4 py-1.5 rounded-full font-bold uppercase tracking-wider text-sm border border-orange-100 mb-6 inline-block">
                Transparent Pricing
            </span>
